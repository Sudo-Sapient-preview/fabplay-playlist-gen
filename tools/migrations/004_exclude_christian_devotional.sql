-- Exclude Christian Devotional tracks from the playable catalog.
-- They remain in songs_metadata_table_sample but must not appear in
...
where m.status = 'completed'
  ...
  -- drop Christian Devotional catalog
  and lower(coalesce(m.genre_label, '')) <> 'christian_devotional';
