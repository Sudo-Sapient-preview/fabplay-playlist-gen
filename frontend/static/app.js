...
return {
  ...
  catEmoji(v){const m={cafe:'☕',qsr:'🍔',jewelry:'💎',fashion:'👟',fine_dine:'🍽️',casual_dine:'🍽️',supermarket:'🛒',hotel:'🏨',furniture:'🛋️',mall:'🏬',spa:'🧘',gym:'💪',salon:'✂️',bookstore:'📚',electronics:'💻',kids_store:'🧸',bar_lounge:'🍸',clinic:'🏥',coworking:'💼'};return m[v]||'🏪'},
  catColor(v){const m={cafe:'#92400E',qsr:'#991B1B',jewelry:'#6D28D9',fashion:'#1D4ED8',fine_dine:'#111827',supermarket:'#15803D',mall:'#4C1D95',hotel:'#0C4A6E',spa:'#065F46',gym:'#7F1D1D',salon:'#831843',bookstore:'#713F12',electronics:'#1E3A8A',kids_store:'#1E40AF',bar_lounge:'#4C1D95',clinic:'#0C4A6E',coworking:'#064E3B'};return m[v]||'#374151'},
